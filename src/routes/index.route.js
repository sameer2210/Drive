...
router.get("/", (req, res) => {
  res.send(
    `<a href="/users" 
     ...
     onmouseover="this.style.backgroundColor='#4F46E5'; this.style.transform='translate(-50%, -50%) scale(1.1)';" 
     onmouseout="this.style.backgroundColor='#4338CA'; this.style.transform='translate(-50%, -50%) scale(1)';">
     Get Started
    </a>
    `
  );
